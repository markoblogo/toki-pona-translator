  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <span
          className={`text-2xl font-bold leading-none ${icon === '>' ? 'text-[#22C55E]' : 'text-[#111]'}`}
        >
          {icon}
        </span>
        <div className="min-w-0">
          <div className="text-base font-semibold leading-tight text-[#111827] line-clamp-2">
            {title}
          </div>
          <div className="mt-1 text-sm leading-relaxed text-[#6B7280] line-clamp-1">
            {subtitle}
          </div>
        </div>
      </div>
